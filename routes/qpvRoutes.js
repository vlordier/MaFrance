...
router.get(
  '/',
  [validateOptionalDepartement, validateOptionalCOG, validateSearchQuery, validatePagination, cacheMiddleware((req) => `qpv:${req.query.dept || ''}:${req.query.cog || ''}:${req.query.commune || ''}:${req.query.cursor || 0}:${req.query.limit || '20'}`)],
  (req, res, next) => {
