...
const { testAssertions } = require('./testUtils/assertions');
const { testLifecycle } = require('./testUtils/lifecycle');
...
function createExpressApp(routeModulePath, mountPath) {
  ...
  // Handle both router exports and object exports with router property
  const routerToUse = route.router || route;
  app.use(mountPath, routerToUse);
